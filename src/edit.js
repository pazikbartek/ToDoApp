        ...
        return(
            <div className="editor">
                ...
                <div className="form">
                    ...
                    <label htmlFor="task">Task name:</label> {this.props.maxLength ? <span className="warning"><b> Maximum length is 50 characters!</b></span> : null} 
                    <input maxLength={50} className="form-control" onChange={this.props.handleTaskName} value={this.props.valueName}  type="text" placeholder="Write your task..." id="task"/>
